...
const Footer: React.FC = () => {
  ...
  const hideFooter = pathname === "/login" || pathname === "/register" ||  /^\/dashboard(\/|$)/.test(pathname) ||  /^\/dashboardCliente(\/|$)/.test(pathname) ||  pathname === "/forgotPassword" ||  pathname === "/resetPassword" ||  pathname === "/emailVerify"; // Ocultar footer en login y register
